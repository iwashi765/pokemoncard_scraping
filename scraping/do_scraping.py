...
#コマンドラインからIDの最小値と最大値、パック名を受け取る

f_min = int(sys.argv[1])
f_max = int(sys.argv[2])
pack = sys.argv[3]

#s_promo_list = {38616,38615,38612,38609,38496,38495,38255,38254,38249,38001,37998,37993,37796,37793,37775,37774,37773,37772,37609,37608,37603}
#sm_promo_list = {37441,37194,37186,37185,37183,37182,37180,37179,37064,36995,36987,36898,36897,36895,36643,36429,36428,36216,36145,36144,36140,35397,35394,35391,35230,35028,35024,35023,34923,34791,34788,34787,34548,34545}
#f_min = 37742
#f_max = 37750
#pack = 'basic_energy'
...
#for url_number in s_promo_list:
